            ...
            <form id="noticeUpdateForm" method="post" action="update.no" enctype="multipart/form-data">
                ...
                <table align="center">
                    ...
                    <tr>
                        ...
                        <td><input type="text" id="writer" class="form-control" value="${ requestScope.n.nBoardWriter }" readonly></td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <c:if test="${ not empty requestScope.n.originName }">
								...
								<!-- 기존의 첨부파일이 있다라는 뜻 -->
								<input type="hidden" name="originName" value="${ requestScope.n.originName }">
								<input type="hidden" name="changeName" value="${ requestScope.n.changeName }">
                            </c:if>
                        </td>
                    </tr>
                    <tr>
