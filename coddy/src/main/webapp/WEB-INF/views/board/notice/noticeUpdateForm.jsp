...
<jsp:include page="../../common/header.jsp" />
    ...
    <div class="content">
        ...
        <div class="innerOuter">
            ...
            <form id="noticeUpdateForm" method="post" action="noticeUpdate.bo" enctype="multipart/form-data">
            	<input type="hidden" name="fBoardNo" value="${ requestScope.b.nBoardNo }">
                <table align="center">
                    <tr>
                        <th><label for="title">제목</label></th>
                        <td><input type="text" id="title" class="form-control" value="${ requestScope.b.nBoardTitle }" name="nboardTitle" required></td>
                    </tr>
                    <tr>
                        <th><label for="writer">작성자</label></th>
                        <td><input type="text" id="writer" class="form-control" value="${ requestScope.b.nBoardWriter }" readonly></td>
                    </tr>
                    <tr>
