		...
		<script>
			...
			function onDelete(e, hboardNo) {
				$.ajax({
					...
					success : function(result) {
						$(e).parent().html("<button type='button' class='btn btn-info' onclick='onRestore(this, " + hboardNo + ");'>복원시키기</button>");
					},
			...
			function onRestore(e, hboardNo) {
				$.ajax({
					...
					url : "adminRestore.hb",
					success : function(result) {
						$(e).parent().html("<button type='button' class='btn btn-danger' onclick='onDelete(this, " + hboardNo + ");'>탈퇴시키기</button>");
					},
