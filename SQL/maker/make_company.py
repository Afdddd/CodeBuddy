...
first_names = ['시큐어', '블랙', '오가닉', '워터', '에코', 'ABC', '홈', '코인', '프로', '프라임', '골드', '쇼셜', '비전', '리프레쉬', '나인', '빅', '나노', '씨드', '넥스트', '그로우', '애즈', '미스터', '블루', '아이', '스마일', '글로벌', '스파이더', '모더', '전자', '디에스', '프로텍트', '브이', '세이', '아이피', '네이티브', '퀸텀', '킹스', '퀸즈', '브랜드', '로얄', 'S', '에스', '플레티넘']
