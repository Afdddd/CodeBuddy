...
first_names = ['시큐어', '블랙', '오가닉', '워터', '에코', 'ABC', '홈', '코인', '프로', '프라임', '골드', '쇼셜', '비전', '리프레쉬', '나인', '빅', '나노', '씨드', '넥스트', '그로우', '애즈', '미스터', '블루', '아이', '스마일', '글로벌', '스파이더', '모더', '전자', '디에스', '프로텍트', '브이', '세이', '아이피', '네이티브', '퀸텀', '킹스', '퀸즈', '브랜드', '로얄', 'S', '에스', '플레티넘', '로즈']
last_names = ['플랜트', '가든', '트레이드', '가이드', '스터디', '화학', '데코', '유니버셜', '병원', '랩스', '쇼핑', '테크', '리서치', '네트워크', 'CD', '테이크아웃', '디자인', '뷰티', '건설', '조합', '코퍼레이션', '주식회사', '컴퍼니', '모바일', 'cs', '투어', '바이오', '파트너스', '전자', '케어', '솔루션', '솔루션즈', '식품', '베이커리', '프렌즈', '오션', '뱅크', '오일']
